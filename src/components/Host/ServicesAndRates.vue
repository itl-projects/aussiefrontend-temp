<template>
  <v-container>
    <v-list class="py-0">
      <v-list-item two-line class="headService">
        <v-list-item-content>
          <v-list-item-title
            style="font-size: 1.8rem; font-weight: bold;color:#fff"
            >Services & Rates</v-list-item-title
          >
          <v-list-item-subtitle style="color: #fff"
            >Services and Rates Let us know pet services(s) you would like to
            ogg to aussiepets</v-list-item-subtitle
          >
        </v-list-item-content>
      </v-list-item>
    </v-list>
        ...
        <v-form ref="form" v-model="valid">
          <v-card flat>
            <!-- <v-row>
              <v-col cols="6">
                <div>
                  <h2>Type of pet you would accept</h2>
                  <p>Select One Or More Type Of Pets From The Following</p>
                  <v-overflow-btn
                    class="my-2"
                    :items="items.title in petTypes"
                ...
                <div>
                  ...
                  <div style="align-items: baseline;" class="boxOrganise">
                    <p>
                      Allow free cancellation up until 14 day before the sta
                    </p>
                    <v-radio :value="policySelected" label=""></v-radio>
                  </div>
                </div>
              </v-col>
              <v-col cols="6">
                <div>
                  ...
                  <div class="boxOrganise">
                    <p>Pick up/drop service at client home</p>
                    <v-switch
                      style="margin: auto"
                      v-model="pickupActive"
                    ></v-switch>
                  </div>
                  <p>Cost per pick up/drop off journey</p>
                  <v-text-field
                    placeholder="price"
                    v-model="pickupCost"
                    dense
                ...
                <div>
                  <h2>Pet Hosting</h2>
                  <div class="boxOrganise">
                    <p>The pets stays at your place overnight</p>
                    <v-switch
                      style="margin: auto"
                      v-model="datas[0].enabled"
                    ></v-switch>
                  </div>
                </div>
              </v-col>
            ...
            <v-card-text>
              <div v-for="(item, i) in items" :key="i">
                <v-list class="py-0">
                  <v-list-item two-line>
                    <v-list-item-avatar tile height="80px">
                      <v-icon style="font-size: 2.5rem;" color="#0FEF70C6">{{
                        datas[i].icon
                      }}</v-icon>
                    </v-list-item-avatar>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        >The pets stays at your place
                        overnight</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-switch
                        v-model="datas[i].enabled"
                        color="#0FEF70C6"
                      ></v-switch>
                    </v-list-item-action>
                  </v-list-item>
                ...
                <v-row
                  ...
                  v-if="datas[i].enabled"
                >
                  <v-col style="padding: 0 8%;" cols="6">
                    <v-label>
                      Base rate pet night (
                      <b>$</b>)
                    ...
                    <div>
                      <v-label
                        >Total number of pets you can take for this
                        service:</v-label
                      >
                      <v-text-field
                    ...
                    <div style="display: flex;justify-content: space-between;">
                      ...
                      <v-checkbox
                        class="mt-0"
                        v-model="item.additional_pet_rate"
                        dense
                        color="#2c7873"
                      ></v-checkbox>
                    </div>
                    ...
                    <v-list class="py-0 ml-sm-8">
                      <v-list-item two-line>
                        <v-list-item-content>
                          <v-list-item-title
                            >Add-on Services for
                            {{ datas[i].heading }}</v-list-item-title
                          >
                          <v-list-item-subtitle
                            >Please select any additional service you would like
                            to offer</v-list-item-subtitle
                          >
                        </v-list-item-content>
                      </v-list-item>
                    </v-list>
                    <v-row v-if="datas[i].enabled" class="py-0">
                      <v-col style="padding: 0 12%" cols="6" sm="8">
                        <div
                          style="display: flex;justify-content: space-between;"
                        >
                          ...
                          <v-checkbox
                            color="#2c7873"
                            class="mt-0"
                            v-model="item.add_on.dog_grooming"
                            dense
                          ></v-checkbox>
                        </div>
                        ...
                        >
                          ...
                          <v-checkbox
                            color="#2c7873"
                            class="mt-0"
                            v-model="item.add_on.dog_training"
                            dense
                          ></v-checkbox>
                        </div>
                        ...
                        >
                          ...
                          <v-checkbox
                            color="#2c7873"
                            class="mt-0"
                            v-model="item.add_on.dog_walking"
                            dense
                          ></v-checkbox>
                        </div>
                ...
                <v-list class="py-0">
                  <v-list-item two-line class="headService">
                    <v-list-item-content>
                      <v-list-item-title
                        style="font-size: 1.8rem; font-weight: bold;color:#fff"
                        >Type of pet you would accept</v-list-item-title
                      >
                      <v-list-item-subtitle style="color: #fff"
                        >Select one or more type of pets from the
                        following</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-icon color="#fff">mdi-information-outline</v-icon>
                    </v-list-item-action>
                  </v-list-item>
                </v-list>
              ...
              <div class="tests">
                <v-list class="py-0">
                  <v-list-item two-line class="headService">
                    <v-list-item-content>
                      <v-list-item-title
                        style="font-size: 1.8rem; font-weight: bold;color:#fff"
                        >Other Services & Policy</v-list-item-title
                      >
                      <v-list-item-subtitle style="color: #fff"
                ...
                <v-list class="py-0">
                  <v-list-item two-line>
                    <v-list-item-content>
                      <v-list-item-title class="servicesTitles"
                        >Pick up/drop off service</v-list-item-title
                      >
                ...
                <v-list class="py-0 pl-3">
                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-subtitle
                        >Pick up/drop service at client
                ...
                <v-row v-if="pick_drop_service" class="pl-8 py-2 pr-2">
                  ...
                  <v-col cols="10" class="py-0">
                    ...
                    <v-text-field
                      v-model="pick_drop_service_cost"
                      placeholder="cost"
                      dense
                    ></v-text-field>
                  </v-col>
              ...
              <div class="tests">
                <v-list class="py-0">
                  <v-list-item two-line>
                    <v-list-item-content>
                      <v-list-item-title class="servicesTitles"
                        >Flexibility Offered</v-list-item-title
                      >
                      <v-list-item-subtitle
                        >Let us know if you have the flexibility to offer the
                        followings:</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-icon color="#2c7873">mdi-information-outline</v-icon>
                ...
                <v-list class="py-0 pl-3">
                  <v-list-item two-line>
                    <v-list-item-content>
                      <v-list-item-title
                        >Last-minute bookings</v-list-item-title
                      >
                      <v-list-item-subtitle
                        >Less then 24 hours notice</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-switch
                        color="#0FEF70C6"
                        v-model="last_min_bookings"
                      ></v-switch>
                    </v-list-item-action>
                  </v-list-item>
                </v-list>
                <v-list class="py-0 pl-3">
                  <v-list-item two-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        >For 1 month or longer</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-switch
                        color="#0FEF70C6"
                        v-model="long_term_bookings"
                      ></v-switch>
                    </v-list-item-action>
                  </v-list-item>
                </v-list>
                ...
                <v-list class="py-0">
                  <v-list-item two-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        >Select the policy which is suitable for you in relation
                        to bookings.</v-list-item-subtitle
                      >
                    </v-list-item-content>
                    <v-list-item-action>
                      <v-icon color="#2c7873" title="required"
                  ...
                  <v-list class="py-0 pl-3">
                    <v-list-item two-line>
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                          >Allow free cancellation up until 14 day before the
                          start of the booking.</v-list-item-subtitle
                        >
                      </v-list-item-content>
                      <v-list-item-action>
                  ...
                  <v-list class="py-0 pl-3">
                    <v-list-item two-line>
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                          >Allow free cancellation up until 7 day before the
                          start of the booking.</v-list-item-subtitle
                        >
                      </v-list-item-content>
                      <v-list-item-action>
                  ...
                  <v-list class="py-0 pl-3">
                    <v-list-item two-line>
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                          >Allow free cancellation up until 12 noon the day
                          before booking starts.</v-list-item-subtitle
                        >
                      </v-list-item-content>
                      <v-list-item-action>
              ...
              <div class="prefrence">
                <div class="pa-2">
                  <v-list class="py-0">
                    <v-list-item two-line class="headService">
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="color: #fff"
                          >What information do you will need to know about a pet
                          before accepting a booking?</v-list-item-subtitle
                        >
                      </v-list-item-content>
                    </v-list-item>
                  </v-list>
                  <br />
                  <v-card-text style="font-size:1rem;" class="pl-5 mt-2"
                    >Just the description, temperament and any special quirks or
                    needs... thats all</v-card-text
                  >
                  <v-textarea
                    v-model="pref_info"
                    rows="2"
                  ...
                  ></v-textarea>
                  <v-card-text style="font-size:1rem;" class="pl-5 mt-2"
                    >Where will you walk my dog? please tell us about nearby
                    parks</v-card-text
                  >
                  <v-textarea
                    v-model="pref_park_info"
                    rows="2"
                    class="mt-3 pl-5"
                    dense
                    color="#0FEF70C6"
                    :rules="[rules.required]"
                  ></v-textarea>
                  <v-card-text style="font-size:1rem;" class="pl-5 mt-4"
                    >What will be the estimated time that you will spend with my
                    pet each day?</v-card-text
                  >
                  <br />
                  <v-card-text style="font-size:1rem;" class="pl-5 mt-2"
                    >I work from home excluding a few errands...pretty much 24 /
                    7</v-card-text
                  >
                  <v-textarea
                    v-model="pref_time_info"
                    rows="2"
                    class="mt-3 pl-5"
                    dense
                    color="#0FEF70C6"
    ...
    <v-overlay :value="processing">
      ...
      >
        <v-col cols="12" class="m-0 p-0">
          ...
          >
            <v-icon v-if="success" :large="true" color="success"
...
export default {
  ...
  methods: {
    getServices() {
      ...
      axios
        .get(urls.URL + "/host/services/", config)
        .then((res) => {
          if (res.data.status)
            this.items.push(
          ...
          this.items.push(
            JSON.parse(
              res.data.data[0].exercise_walk_service.replace(/'/g, '"')
            )
          );
          this.items.push(
    ...
    getpetTypes() {
      ...
      axios
        .get(urls.URL + "/pet/type/?type=Dog", config)
        .then((res) => {
          if (res.data.status) {
            res.data.data.forEach((el) => {
              this.petTypes.push({
                title: el.subType,
                checked: this.types_of_pet.includes(el.subType),
              });
            });
            this.petTypes.push({
              title: "Cats",
              checked: this.types_of_pet.includes("Cats"),
            });
            this.petTypes.push({
              title: "Birds",
              checked: this.types_of_pet.includes("Birds"),
            });
            this.petTypes.push({
              title: "Rabbit / Guinea Pig",
              checked: this.types_of_pet.includes("Rabbit / Guinea Pig"),
            });
          } else {
            this.petTypes = [];
          }
    ...
    saveSettings() {
      ...
      this.items.forEach((arr, i) => {
        if (arr.optional == "on" && arr.base_rate_pernight == "") {
          this.alert.msg =
            "Please provide " + this.datas[i].heading + " Base Price";
          status = true;
          return;
        }
      });
      ...
      axios
        .post(urls.URL + "/host/services/", data_to_save, config)
        .then((res) => {
          if (res.data.status) {
...
.switchClass {
  ...
  caret-color: #0fef70c6 !important;
}
