      ...
      <v-container grid-list-xs>
        ...
        <div class="div-box">
          ...
          <v-row>
            ...
            <v-col class>
              <v-tabs v-model="tab" background-color="#ffffff"  dark icons-and-text height="95px" style="display:flex;justify-content:center">
                <v-tabs-slider></v-tabs-slider>

                <v-tab href="#tab-1">
                  pet hosting
                  <br />At Sitter’s Home
                  <v-img src="@/assets/images/Frame.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>

                <v-tab href="#tab-2">
                  Pet Sitting
                  <br />At Pet’s home
                 <v-img src="@/assets/images/tab-2.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>

                <v-tab href="#tab-3">
                  Pet Day Care
                  <br />Services
                  <v-img src="@/assets/images/tab-3.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>
                <v-tab href="#tab-4">
                  House Visits
                  <br />gardens/plants
                  <v-img src="@/assets/images/tab-4.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>
                <v-tab href="#tab-5">
                  Exercise &
                  <br />walkies services
                  <v-img src="@/assets/images/tab-5.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>
                <v-tab href="#tab-6">
                  Pet Grooming
                  <br />Services
                    <v-img src="@/assets/images/tab-6.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>
                <v-tab href="#tab-7">
                  Pet Training
                  <br />services
                  <v-img src="@/assets/images/tab-7.svg" max-width="52px" max-height="52px" contain></v-img>
                </v-tab>
              </v-tabs>
            </v-col>
          </v-row>
